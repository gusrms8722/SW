...
#과일 리스트중에서 제일 첫번째 과일은 무엇입니까?
print("과일 리스트중 제일 첫번째 과일은?", fruits[0])
print("과일 리스트중 제일 마지막 과일은?", fruits[-1])
fruits.append('두리안')
print("과일 목록 : ", fruits)
...
#오름차순 정열
fruits.sort()
print("오름차순 정열;",fruits)

#내림차순 정열
fruits.sort(reverse= True)
print("내림차순 정열 : ",fruits)

'''
리스트를 원하는 모양으로 자르는 슬라이싱
'''
print("과일 리스트중 2,3,4 번 과일은 무엇입니까?" , fruits[1:4])#1번지 에서부터 4번지 앞까지
print("과일 리스트중에서 1~3번 과일은?" , fruits[0:3])
print("과일 리스트중에서 1~3번 과일은?" , fruits[:3])#처음부터 2번지 까지

print("과일 리스트중에서 3번과일부터 마지막 까지 과일은?" , fruits[2:]) #2번지 부터 마지막 까지

print("과일 리스트 중 1,3,5 과일은",fruits[::2])
...
#pop()메소드
fruits.pop() #마지막 항목 삭제할떄 사용하는 메소드
print("과일 목록(삭제)", fruits)

#del() 키워드
del fruits[0] #번지를 지정하여 삭제
